...
public class ExchangeRateClientFactory {
    ...
    public List<ExchangeRatesClient> getAllExchangeRatesClients(){
        Collection<ExchangeRatesClient> expressionStrategyCollection =
                beanFactory.getBeansOfType(ExchangeRatesClient.class).values();
        return new ArrayList<>(expressionStrategyCollection);
    }
